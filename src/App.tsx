    ...
    >
      ...
      >
        ...
        <View style={styles.pickerContainer}>
          ...
          >
            <Picker.Item label="toplama(+)" value="addition" />
            <Picker.Item label="çıkarma(-)" value="subtraction" />
            <Picker.Item label="çarpma(*)" value="multiplication" />
            <Picker.Item label="bölme(/)" value="division" />
          </Picker>
          ...
          >
            <Picker.Item label="tam sayılar" value="wholeNumber" />
            <Picker.Item label="ondalıklı sayı" value="decimal" />
          </Picker>
        </View>
        ...
        {won ? (
          <View>
            <Text style={{ color: activeTheme.textColor }}>Kazandın!</Text>
            <Button
              onPress={handleRestart}
              title="yeniden başlat"
              color={activeTheme.buttonColor}
              accessibilityLabel="Tekrar oynamak için butona basın."
            />
          </View>
        ) : (
